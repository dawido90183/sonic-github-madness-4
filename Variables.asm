...
VDP_Command_Buffer:    equ    $FFFFC800 ; buffered Sonic graphics ($17 cells) ($2E0 bytes)
...
v_generictimer:	equ $FFFFF614	; generic timer, decrements to 0 in vblank (2 bytes)
...
v_SplashSkip:		equ $FFFFFFF6	; Splash Screen Skip
