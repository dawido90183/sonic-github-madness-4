...
@stop:	dc.b 7,	fr_Stand, fr_Stand, afEnd
		even
@float1:	dc.b 7,	$FE, fr_Walk21, fr_Walk32, fr_Walk42, fr_Run12, fr_Run13, fr_Run14, fr_Run21, fr_Stand, afEnd
		even
@float2:	dc.b 7,	$FE, fr_Walk21, fr_Walk32, fr_Walk42, fr_Run12, fr_Run13, fr_Run14, fr_Run21, fr_Stand, afEnd
		even
@spring:	dc.b $2F, $FE, fr_Walk21, fr_Walk32, fr_Walk42, fr_Run12, fr_Run13, fr_Run14, fr_Run21, fr_Stand, afEnd
		even
...
@drown:	dc.b $2F, fr_Stand, afEnd
		even
@death:	dc.b 3,	$FE, fr_Walk21, fr_Walk32, fr_Walk42, fr_Run12, fr_Run13, fr_Run14, fr_Run21, fr_Stand, afEnd
		even
@hurt:	dc.b 3,	$FE, fr_Walk21, fr_Walk32, fr_Walk42, fr_Run12, fr_Run13, fr_Run14, fr_Run21, fr_Stand, afEnd
		even
@waterslide:
...
@null:	dc.b $77, fr_Stand, afChange, id_Walk
		even
@float3:	dc.b 3,	$FE, fr_Walk21, fr_Walk32, fr_Walk42, fr_Run12, fr_Run13, fr_Run14, fr_Run21, fr_Stand, afEnd
		even
@float4:	dc.b 3,	$FE, fr_Walk21, fr_Walk32, fr_Walk42, fr_Run12, fr_Run13, fr_Run14, fr_Run21, fr_Stand, afEnd
		even
