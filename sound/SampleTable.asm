...
SampleTable:
	...
	dcSample	TYPE_PCM,		Chaotix's_Crash,		19030		        ; $AA Nano: i didn't find the perfect sample rate so i make the pcm uses 19030
	dc.w	-1	; end marker
...
; Stuff for Splash Screens
	...
	incdac	Chaotix's_Crash, "sound/dac/Knuckles Chaotix/Crash.pcm"
