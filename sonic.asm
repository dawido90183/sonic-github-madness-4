...
splash_entry macro art,tilemap,palette,size,music_id,duration_in_frames
    ...
    splash_entry Nem_Splash_Monke,Eni_Splash_Monke,Pal_Splash_Monke,$20,bgm_ExtraLife,480 ; my dumbass brain did not get it how it works, untill now :P
	dc.l	-1 ; end marker
